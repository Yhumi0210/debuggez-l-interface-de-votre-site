...
const _retrieveWeatherForecastApiData = coordinates => fetch(`https://api.weatherstack.com/current?access_key=${ACCESS_KEY}&query=${coordinates.latitude},${coordinates.longitude}`)
    .then(res => res.json())
    .catch(err => {})
